 ...
 * міряємо ЙОГО час, а реальний рахуємо через перерахунок від живої гри:
 * на старій версії (HP 95, дві фази) цей самий бот клав боса за 33,4 с,
 * а жива гра тривала близько двох хвилин — коефіцієнт 3,3.
 * Фаза 3 щита не має, тож слабкий гравець втрачає в ній куди менше:
 * для неї беремо 1,8. Обидві оцінки друкуємо поруч.
 */
...
console.log('    жива гра, оцінка: ' + weighted + '-' + linear + ' с   (ціль 60-80 с)');
console.log();
...
ok(weighted >= 60 && linear <= 80, 'перерахована тривалість живої гри вкладається в 60-80 с',
   weighted + '-' + linear + ' с');
