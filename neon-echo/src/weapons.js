...
export const WEAPONS = {
  ...
  arc: {
    ...
    dmg: [2, 2, 3], reach: 26, swing: [0.18, 0.18, 0.30], res: 'заряд клинка',
  ...
  whip: {
    ...
    dmg: [1.8], reach: 76, swing: [0.45], res: 'нема',
  ...
  brand: {
    ...
    dmg: [3], reach: 30, swing: [0.45], res: 'нема',
  ...
  chrono: {
    ...
    dmg: [2], reach: 59, swing: [0.22], res: 'кулдаун 1,2 с',
  ...
  claws: {
    ...
    dmg: [1.3], reach: 22, swing: [0.10], res: 'нема',
