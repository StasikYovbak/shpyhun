...
Символи:
  ...
  '*' фрагмент Ехо-Призми   '?' дата-лог (секрет)
...
L1.nook(64, 7, 6, '?')                        # СЕКРЕТ: дата-лог
L1.ent(3, '@')
...
L3.nook(74, 6, 6, '*')                        # СЕКРЕТ: фрагмент Ехо-Призми 1/3
...
L5.nook(100, 6, 6, '?')                       # СЕКРЕТ: дата-лог
...
L6.nook(60, 5, 6, '*')                        # СЕКРЕТ: фрагмент Ехо-Призми 2/3
L6.ent(3, '@')
...
L7.nook(76, 5, 6, '?')                        # СЕКРЕТ: дата-лог
L7.ceil(0, 210, 1)
...
L9.nook(210, 6, 6, '*')                       # СЕКРЕТ: фрагмент Ехо-Призми 3/3
